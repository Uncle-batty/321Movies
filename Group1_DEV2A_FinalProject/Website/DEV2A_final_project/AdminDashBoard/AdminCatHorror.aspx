<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminCatHorror.aspx.cs" Inherits="DEV2A_final_project.AdminDashBoard.AdminCatHorror" %>
  ...
  <body>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                <asp:GridView ID="GridViewHorror" runat="server" CssClass="table table-bordered table-responsive" AllowCustomPaging="False" AllowSorting="False" BorderStyle="Groove" UseAccessibleHeader="True" AutoGenerateSelectButton="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True"  OnRowDeleting="GridViewHorror_RowDeleting" RowStyle-CssClass="selected-row" OnRowEditing="GridViewHorror_RowEditing" >
                    <Columns>
