...
namespace DEV2A_final_project
{
    public class DBMethods2
    {
        ...
        public string  conn2 = "Data Source=.;Initial Catalog=Movies321;Integrated Security=True";
        ...
        public static bool InsertMovies(string movieId,string movieTitle, string runtime, string releaseYear, string trailerLink, string ratings, int ageRating, int views,string shortDescription, string DirectorName, string DirectorLastName, int DirectorId)
        {
                    ...
                    using (SqlConnection connection = new SqlConnection("Data Source =.; Initial Catalog = Movies321; Integrated Security = True"))
                    {
                        try
                        {
                            connection.Open();
        ...
        {
        string connectionString = "Data Source =.; Initial Catalog = Movies321; Integrated Security = True";
        ...
        {
            SqlDataReader reader = null;
            SqlConnection conn = new SqlConnection("Data Source =.; Initial Catalog = Movies321; Integrated Security = True");
            SqlCommand cmd;
