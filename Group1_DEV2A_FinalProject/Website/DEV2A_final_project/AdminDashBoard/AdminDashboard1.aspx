  ...
  <body>
            ...
            <div class="input-group">
              <input
                ...
                aria-label="Search"
                  id="Lu"
                  runat="server" />
              <%--button class="btn btn-primary" type="submit" runat="server" onserverclick="btnlookup">--%>
                <asp:Button class="btn btn-primary bi bi-search" runat="server" OnClick="btnlookup" />
              <%--  <asp:HyperLink ID="HyperLink8" class="btn btn-primary bi bi-search" runat="server" onclick="btnlookup"  >
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-responsive" AllowCustomPaging="False" AllowSorting="False" BorderStyle="Groove" UseAccessibleHeader="True" AutoGenerateSelectButton="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting" RowStyle-CssClass="selected-row" OnRowEditing="GridView1_RowEditing" >
                    <Columns>
