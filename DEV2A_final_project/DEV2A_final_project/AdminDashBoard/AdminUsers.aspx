                  ...
                  <nav class="navbar-dark">
                      <ul class="navbar-nav">
                          ...
                          <li class="my-4">
                            ...
                            <li>
                                 <div class="sidebar-link nav-link" >
                                     <span class="me-2"><i class="bi bi-receipt"></i></span>
                                    <asp:Button ID="Button2" runat="server" Text="Generate Invoice"  CssClass="btn btn-dark" OnClick="Generate_Click" />
                                 </div>
              ...
              <div class="card-body py-5">Payments</div>
                <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/AdminDashBoard/AdimViewPayments.aspx">
                  ...
                  <div class="container-fluid">
                      <div class="row">
                          <div class="col">
                              <asp:GridView ID="GridView2" runat="server" CssClass="table table-bordered table-responsive" AllowCustomPaging="False" AllowSorting="False" BorderStyle="Groove" UseAccessibleHeader="True" AutoGenerateSelectButton="True" AutoGenerateDeleteButton="False" AutoGenerateEditButton="False" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" OnRowDeleting="GridView2_RowDeleting" RowStyle-CssClass="selected-row">
