<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUploadInvoices.aspx.cs" Inherits="DEV2A_final_project.AdminDashBoard.AdminUploadInvoices" %>
                  ...
                  <nav class="navbar-dark">
                      <ul class="navbar-nav">
                          ...
                          <li class="my-4">
                            ...
                            <li>
                              <asp:HyperLink ID="HyperLink1" class="nav-link px-3 sidebar-link" runat="server" NavigateUrl="~/AdminDashBoard/AdminUsers.aspx" onclick="Users_Click">
