        ...
        <main class="mt-5 pt-3">
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <asp:GridView ID="GridViewPayments" runat="server" CssClass="table table-bordered table-responsive" AllowCustomPaging="False" AllowSorting="False" BorderStyle="Groove" UseAccessibleHeader="True"     RowStyle-CssClass="selected-row" >
                                <Columns>
                                </Columns>
                            </asp:GridView>
                        </div>
