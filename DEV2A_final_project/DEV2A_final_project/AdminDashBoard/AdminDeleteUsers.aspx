<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDeleteUsers.aspx.cs" Inherits="DEV2A_final_project.AdminDashBoard.AdminDeleteUsers" %>
...
<html lang="en">
  ...
  <body>
              ...
              <asp:HyperLink ID="HyperLink1" runat="server">HyperLink</asp:HyperLink>
                   ...
                   <li>
                      <a href="#" class="nav-link px-3 active">
                        ...
                        <span>Dashboard-Delete-Users</span>
                      </a>
                  </li>
    ...
    <main class="mt-5 pt-3">
     ...
     <div class="container">
    <div class="card">
      <img src="path_to_user_avatar.jpg" class="card-img-top" alt="User Avatar">
      <div class="card-body">
        <h5 class="card-title">User Name</h5>
        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        <a href="#" class="btn btn-primary">Read More</a>
        <button type="button" class="btn btn-danger float-right ml-2">Delete</button>
