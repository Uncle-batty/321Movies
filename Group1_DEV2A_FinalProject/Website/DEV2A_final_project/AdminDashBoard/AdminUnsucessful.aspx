<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUnsucessful.aspx.cs" Inherits="DEV2A_final_project.AdminDashBoard.AdminUnsucessful" %>
          ...
          <main class="mt-5 pt-3">
              <div class="container-fluid">
                ...
                <span class="ms-auto">
                 ...
                 <div class="card border-danger  text-center  card-sm">
                  <div class="card-body">
                    <h5 class="card-title"><i class="bi bi-exclamation-circle-fill text-danger "></i> Failed!</h5>
                    <p class="card-text">The operation  Failled.</p>
                    <div class="text-center">
                      <asp:button class="btn btn-danger " runat="server" Text="Ok" OnClick="ok_Click" ></asp:button>
                    </div>
                  </div>
                </div>
               </div>
