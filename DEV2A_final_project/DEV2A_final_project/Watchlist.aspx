<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Watchlist.aspx.cs" Inherits="DEV2A_final_project.Watchlist" %>
...
<header class="top-bar">
  <div class="Search_container1">
    ...
    <div class="nav-links">
      ...
      <a style="margin-right:50px;color:#05ab05;text-decoration:underline" href="#">Watch List</a>
...
<div class="labels">
     <asp:Label ID="Label1" runat="server">Your WatchList</asp:Label> 
 </div>
