<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEditMovies.aspx.cs" Inherits="DEV2A_final_project.AdminDashBoard.AdminEditMovies" %>
                      ...
                      <ul class="navbar-nav">
                          ...
                          <li>
                              <a href="#" class="nav-link px-3 active">
                                  ...
                                  <span>Dashboard-Edit-Movie</span>
                              </a>
                          </li>
                      ...
                      <div class="card">
                          <div class="card-body">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="moviId" placeholder="Movie ID" runat="server" readonly="readonly" >
                              </div>

                              <div class="form-group">
                                  <label for="Title"></label>
                                  <input type="text" class="form-control" id="movieTitle" placeholder="Movie Title" runat="server" readonly="readonly">
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="Catergory" placeholder="Catergory ID" runat="server">
                              </div>
                              ...
                              <asp:Button type="submit" class="btn btn-primary" runat="server" Text="Update Movie" onclick="update_Click" ></asp:Button>
                              <asp:Button type="button" class="btn btn-secondary float-right" runat="server" Text="Cancel" OnClick="cancel_Click"></asp:Button>
                          </div>
                      </div>
                  </div>
              </div>
